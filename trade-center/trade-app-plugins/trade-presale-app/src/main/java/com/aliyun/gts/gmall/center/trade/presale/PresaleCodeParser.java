...
public class PresaleCodeParser implements BizCodeParser<BizCodeEntity> {

    @Override
    public boolean match(BizCodeEntity bizCodeEntity) {
        return ExtBizCode.PRE_SALE.equalsIgnoreCase(bizCodeEntity.getBizCode());
    }

    @Override
    public String getBizCode(BizCodeEntity bizCodeEntity) {
        return ExtBizCode.PRE_SALE;
    }
}
