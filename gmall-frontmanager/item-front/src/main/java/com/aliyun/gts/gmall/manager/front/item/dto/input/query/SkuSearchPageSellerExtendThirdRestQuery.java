...
/**
 * 
 * @Title: SkuSearchPageSellerExtendThirdRestQuery.java
...
@Getter
@Setter
public class SkuSearchPageSellerExtendThirdRestQuery extends AbstractQueryRestRequest {
    ...
    public void checkInput() {
        ...
        ParamUtil.notEmpty(sellerIdsFilter, "[sellerIdsFilter]: " + I18NMessageUtils.getMessage("cannot.be.empty")); // # "sellerIdsFilter不能为空"
    }
}
