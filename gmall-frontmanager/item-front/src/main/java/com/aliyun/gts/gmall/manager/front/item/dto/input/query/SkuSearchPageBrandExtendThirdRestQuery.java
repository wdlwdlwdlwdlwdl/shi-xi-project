...
/**
 * 
 * @Title: SkuSearchPageBrandExtendThirdRestQuery.java
...
@Getter
@Setter
public class SkuSearchPageBrandExtendThirdRestQuery extends AbstractQueryRestRequest {
    ...
    public void checkInput() {
        ...
        ParamUtil.notEmpty(brandIdsFilter, "[brandIdsFilter]: " + I18NMessageUtils.getMessage("cannot.be.empty")); // # "brandIdsFilter不能为空"
    }
}
