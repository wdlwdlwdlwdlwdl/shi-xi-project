...
@Data
public class ApplyInfo extends AbstractOutputInfo {
    ...
    @Data
    public static class BusinessInfo extends AbstractOutputInfo {
        ...
        public String[] getTimeRange() {
            ...
            return new String[] { timeRangeStart, timeRangeEnd };
        }
    }

    @Data
    public static class FundInfo extends AbstractOutputInfo {
