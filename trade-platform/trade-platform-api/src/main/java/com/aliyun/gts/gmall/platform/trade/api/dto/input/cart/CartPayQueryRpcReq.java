...
public class CartPayQueryRpcReq extends AbstractQueryRpcRequest {
    ...
    public void checkInput() {
        ...
        ParamUtil.nonNull(payMode,"[payMode] " + I18NMessageUtils.getMessage("cannot.empty"));
        ParamUtil.nonNull(cityCode,"[cityCode] " + I18NMessageUtils.getMessage("cannot.empty"));
    }
