...
import com.aliyun.gts.gmall.platform.trade.core.ability.order.OrderCancelMsgAbility;
...
@Service
public class OrderCancelNotifyServiceImpl implements OrderCancelNotifyService {

    @Autowired
    private OrderCancelMsgAbility orderCancelMsgAbility;
    @Autowired
    ...
    public void afterStatusChange(OrderChangeNotify change) {
        ...
        // 发消息
        orderCancelMsgAbility.messageSend(change);
    }
