...
//        langList.add("messages_mall_trade_platform_en.properties");
        langList.add("messages_mall_trade_platform_kk.properties");
        langList.add("messages_mall_trade_platform_ru.properties");
        Properties defalutProp = new Properties();
        // 获取resources目录下的example.properties文件的输入流
        InputStream inputStream = PropertiesUtil.class.getClassLoader().getResourceAsStream("messages_mall_trade_platform_en.properties");
        if (inputStream != null) {
            // 加载输入流
