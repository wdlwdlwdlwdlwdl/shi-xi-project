...
@Component
public class OrderEsSearchParamHandler implements
    ProcessFlowNodeHandler<OrderSearchRpcReq, SearchRequest> {

    @Autowired
    OrderSearchService orderSearchService;

    @Override
    public SearchRequest handleBiz(Map<String, Object> context, OrderSearchRpcReq req) {
