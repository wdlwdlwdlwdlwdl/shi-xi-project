...
@Component
public class AdminOrderSearchResultHandler implements ProcessFlowNodeHandler<ListOrder, FlowNodeResult> {
    ...
    public FlowNodeResult handleBiz(Map<String, Object> map, ListOrder listOrder) {
        TradeBizResult<PageInfo<MainOrderDTO>> result = orderSearchService.processAdminResult(listOrder);
        if(result.isSuccess()){
