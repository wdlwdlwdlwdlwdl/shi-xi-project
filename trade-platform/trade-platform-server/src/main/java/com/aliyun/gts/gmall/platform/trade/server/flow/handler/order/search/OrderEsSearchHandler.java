...
@Component
public class OrderEsSearchHandler implements ProcessFlowNodeHandler<SearchRequest, ListOrder> {

    @Autowired
    OrderSearchService orderSearchService;

    @Override
    public ListOrder handleBiz(Map<String, Object> map, SearchRequest request) {
