...
@Component
public class CustomerOrderSearchResultHandler implements ProcessFlowNodeHandler<ListOrder, FlowNodeResult> {
    ...
    public FlowNodeResult handleBiz(Map<String, Object> map, ListOrder listOrder) {
        TradeBizResult<PageInfo<MainOrderDTO>> result = orderSearchService.processCustomerResult(listOrder);
        if(result.isSuccess()){
