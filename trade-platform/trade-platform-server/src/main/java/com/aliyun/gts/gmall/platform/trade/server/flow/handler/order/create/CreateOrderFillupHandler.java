...
@Component
public class CreateOrderFillupHandler extends AdapterHandler<TOrderCreate> {
    ...
    public void handle(TOrderCreate inbound) {
        ...
        for (MainOrder main : order.getMainOrders()) {
            main.setPrimaryOrderStatus(OrderStatusEnum.ORDER_WAIT_PAY.getCode());
            ...
            for (SubOrder sub : main.getSubOrders()) {
                sub.setOrderStatus(OrderStatusEnum.ORDER_WAIT_PAY.getCode());
