...
@Component
public class SellerOrderSearchParamHandler implements
    ProcessFlowNodeHandler<SellerOrderQueryRpcReq, SimpleSearchRequest> {

    @Autowired
    OrderSearchService orderSearchService;

    @Override
    public SimpleSearchRequest handleBiz(Map<String, Object> context, SellerOrderQueryRpcReq req) {
