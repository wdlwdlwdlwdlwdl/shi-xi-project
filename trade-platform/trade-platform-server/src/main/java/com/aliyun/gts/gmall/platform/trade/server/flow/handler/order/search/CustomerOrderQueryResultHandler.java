...
@Component
public class CustomerOrderQueryResultHandler implements ProcessFlowNodeHandler<ListOrder, FlowNodeResult> {
    ...
    public FlowNodeResult handleBiz(Map<String, Object> map, ListOrder listOrder) {
        TradeBizResult<PageInfo<MainOrderDTO>> result = orderQueryService.processCustomerResult(listOrder);
        if(result.isSuccess()){
