...
import com.aliyun.gts.gmall.platform.trade.core.message.consumer.OversaleProcessConsumer;
import com.aliyun.gts.gmall.platform.trade.core.message.consumer.PaySuccessConsumer;
import com.aliyun.gts.gmall.platform.trade.core.message.consumer.RefundSuccessConsumer;
...
public class MockPayMessage {
    ...
    @Autowired
    private OversaleProcessConsumer oversaleProcessConsumer;

    @Autowired
    private RefundSuccessConsumer refundSuccessConsumer;
    ...
    public void sendPaySuccess(Long primaryOrderId, Long custId, Integer stepNo) {
        ...
        StandardEvent event = new DefaultStandardEvent("", "");
        event.setPayload(MqPayload.make(msg));
        paySuccessConsumer.process(event);
    }
    ...
    public void sendOverSale(Long primaryOrderId) {
        ...
        StandardEvent event = new DefaultStandardEvent("", "");
        event.setPayload(MqPayload.make(msg));
        oversaleProcessConsumer.process(event);
    }
    ...
    public void sendRefundSuccess(MainReversal mainReversal, Integer stepNo) {
        ...
        StandardEvent event = new DefaultStandardEvent("", "");
        event.setPayload(MqPayload.make(msg));
        refundSuccessConsumer.process(event);
    }
}
